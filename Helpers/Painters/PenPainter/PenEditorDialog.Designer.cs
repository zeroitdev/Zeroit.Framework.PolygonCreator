...
namespace Zeroit.Framework.PolygonCreator.Editors.PenPainter
{
    partial class PenPainterEditorDialog
    {
        ...
        {
            this.thematic1501 = new Zeroit.Framework.PolygonCreator.ThemeManagers.SpicyLips();
            ...
            this.linePanel2 = new Zeroit.Framework.PolygonCreator.Editors.PenPainter.PenPainterPanel();
            this.linePanel1 = new Zeroit.Framework.PolygonCreator.Editors.PenPainter.PenPainterPanel();
            ...
            this.thematic1501.Colors = new Zeroit.Framework.PolygonCreator.ThemeManagers.Bloom[0];
        ...
        private Zeroit.Framework.PolygonCreator.ThemeManagers.SpicyLips thematic1501;

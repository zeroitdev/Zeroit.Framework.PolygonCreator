...
namespace Zeroit.Framework.PolygonCreator
{
    ...
    public partial class PolyEditorDialog
    {
...

        {
            ...
            this.magnifierScreen.Image = new Bitmap(lensbmp, lensbmp.Width * magnifierZoom, lensbmp.Height * magnifierZoom); // Assign lens bitmap with magnifierZoom level to the picture box
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (zoomCheckBox.Checked)
            {
                ...
                try
                {
                    ...
                    {
                        lensbmp = new Bitmap(200, 200); // Have a bitmap for lens
                        ...
                        magnifierScreen.Image = new Bitmap(lensbmp, lensbmp.Width * (int)zoomInOut, lensbmp.Height * (int)zoomInOut); // Assign lens bitmap with magnifierZoom level to the picture box

                    }

                    if (zoomInOut == constantZoom)
                    {
                        lensbmp = new Bitmap(100, 100); // Have a bitmap for lens
